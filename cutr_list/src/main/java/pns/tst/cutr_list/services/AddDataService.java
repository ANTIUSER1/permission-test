...
public class AddDataService {
    ...
    зависит от задачи
    если для боевого применения на супкр-нагруженном проде, то

    1---  сделать его прототайпом
    2---  использовал бы    synchronizedList(), а не ArrayList
    3---  можно использовать стрим-апи
